"""
Qwen3 local smoke tests through the FULL LangGraph agent.
...
latency, execution status. Saves JSON to evaluation/results/.
"""
...
def run_smoke():
    ...
    for case in SMOKE_CASES:
        ...
        # Planner call count from execution_trace (actual invocations, not derived)
        ...
        rec = {
            **case,
            ...
            "final_answer": trace["final_answer"][:400],
    ...
    out = Path("evaluation/results/qwen3_smoke.json")
    ...
    print(f"\n=== SMOKE SUMMARY: {n_pass}/{len(results)} PASS ===")
    return results
